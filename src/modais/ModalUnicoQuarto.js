...
export function ModalUnicoQuarto({visible, onClose, onSubmit}){
  ...
  const Calcular = () => {
    if(largura > 0 && comprimento > 0){
      ...
      let tugPerimetro = Math.round((perimetro/5)+0.49);
  ...
  return(
    ...
    <Modal transparent={true} visible={tueModal} onRequestClose={() => {Alert.alert("Modal has been closed")}}>
      ...
      <Cabecalho title="Quarto" onPress={closeModal} onPress2={handleSubmit} onPress3={handleShare}/>
      ...
      <View style={styles.cards2}>
        ...
        <Text style={styles.textinho}>
          "Em salas e dormitórios devem ser previstos pelo menos um ponto de tomada para cada 5m, ou fração, de perímetro, devendo esses pontos ser espaçados tão uniformemente quanto possível."
        </Text>
      </View>
